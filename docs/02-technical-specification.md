...
Финальная система строится как набор независимых NestJS-микросервисов.
...
Проект не создаётся сразу в финальной архитектуре.
...
Это фундаментальная часть учебного процесса.
